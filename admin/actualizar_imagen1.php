...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  producto set productImage1='$productimage1' where id='$pid' ");
$_SESSION['msg']="
...
$query=mysqli_query($con,"select nombre_producto,productImage1 from producto where id='$pid'");
$cnt=1;
