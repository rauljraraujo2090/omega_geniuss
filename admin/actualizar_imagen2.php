...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  producto set productImage2='$productimage2' where id='$pid' ");
$_SESSION['msg']="
...
$query=mysqli_query($con,"select nombre_producto,productImage2 from producto where id='$pid'");
$cnt=1;
...
<div class="controls">
<input type="text"    name="productName"  readonly value="<?php echo htmlentities($row['nombre_producto']);?>" class="span8 tip" required>
</div>
</div>
