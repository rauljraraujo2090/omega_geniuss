...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  producto set productImage3='$productimage3' where id='$pid' ");
$_SESSION['msg']="
...
$query=mysqli_query($con,"select nombre_producto,productImage3 from producto where id='$pid'");
$cnt=1;
