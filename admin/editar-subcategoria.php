...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update subcategoria set categoryid='$category',subcategory='$subcat',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select categoria.id,categoria.categoryName,subcategoria.subcategory from subcategoria join categoria on categoria.id=subcategoria.categoryid where subcategoria.id='$id'");
...
<?php $ret=mysqli_query($con,"select * from categoria");
