        ...
        --->
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                    <img src="assetss/img/ampliacion.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    <h3> Servicio de Repotenciacion de Laptops: Ampliacion Memoria, Disco Solido, Cambio Pantalla, Teclados y Bisagras. Dell Lenovo HP Toshiba Asus Acer Macbook, repuestos</h3>

                    <ul>
                        <li>
                            <i class="bx bx-store-alt"></i>
                            <div>
                                <h5>Precio: Desde S/.50</h5>
                                <p>Aceptamos todos los medios de pago</p>

                                <p>*Valido solo para pagos en Efectivo o Transferencia</p>

                                <p>*5% adicional con Pagos con Tarjeta</p>
                                <div class="social">
                                    <button class="btn btn-primary">Whatsap</button>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <p> Ofrecemos Servicio de Reparacion y Repotenciacion de Equipos de computo en General; nos especializamos en Laptops de todas las marcas.
Servicios:</p>
                    </div>
                    <p>


 <li> Ampliacion de Memoria Ram</li>
<li>Cambio de Discos a Disco Solido SSD</li>
<li>Ampliacion de Disco actual</li>
<li>Reemplazo de Pantalla de Laptop por Rotura o mal funcionamiento</li>
<li>Reemplazo de Teclado de Laptop por mal funcionamiento</li>
</li>
