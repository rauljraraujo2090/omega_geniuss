        ...
        --->
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                    <img src="assetss/img/instalacion.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    <h3> Servicio de Instalacion de Software: Apple y Windows</h3>

                    <ul>
                        <li>
                            <i class="bx bx-store-alt"></i>
                            <div>
                                <h5>Precio: Desde S/.40</h5>
                    ...
                    <div>
                        ...
                        <p> Si necesita de nuevos Programas ofrecemos:</p>
                    </div>
                    <p>


 <li>Venta de Software Original</li>
 <li>Instalación de Software previamente adquirido por Ud.</li>
 <li>Instalación de versiones de prueba de Software original</li>
 <li>Configuración de Software (todas las versiones)</li>
 <li>Sistemas Operativos Windows</li>
 <li>Sistemas Operativos Apple</li>
