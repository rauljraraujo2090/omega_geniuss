...
if (isset($_POST['ordersubmit'])) {
	...
	if (strlen($_SESSION['login']) == 0) {
		...
		foreach ($value as $qty => $val34) {
			...
			mysqli_query($con, "insert into pedidos(userId,productId,quantity) values('" . $_SESSION['id'] . "','$qty','$val34')");
										...
										<tbody>
											...
											if (!empty($query)) {
												while ($row = mysqli_fetch_array($query)) {
													...
													$subtotal = $_SESSION['cart'][$row['id']]['quantity'] * $row['precio_producto'] + $row['shippingCharge'];
													$totalprice += $subtotal;
											...
											?>
													...
													<tr>
														...
														<td class="cart-product-name-info">
															<h4 class='cart-product-description'><a href="detalle_producto.php?pid=<?php echo htmlentities($pd = $row['id']); ?>"><?php echo $row['nombre_producto'];
														...
														<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "S/" . " " . $row['precio_producto']; ?>.00</span></td>
														<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "S/" . " " . $row['shippingCharge']; ?>.00</span></td>

														<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity'] * $row['precio_producto'] + $row['shippingCharge']); ?>.00</span></td>
													</tr>
