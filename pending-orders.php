...
<?php $query=mysqli_query($con,"select producto.productImage1 as pimg1,producto.productName as pname,producto.id as c,pedidos.productId as opid,pedidos.quantity as qty,producto.precio_producto as pprice,producto.shippingCharge as shippingcharge,pedidos.paymentMethod as paym,pedidos.orderDate as odate,pedidos.id as oid from pedidos join producto on pedidos.productId=producto.id where pedidos.userId='".$_SESSION['id']."' and pedidos.paymentMethod is null");
$cnt=1;
